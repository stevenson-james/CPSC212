;; James Stevenson
;; model of throwing darts at a circular bullseye of radius 1
;; inside a square of side 2
;; famous experiment for approximating the special number pi
...
to throw-darts
  create-darts number-of-darts
  ask darts [
    set shape "dart"
    set size 0.2
    setxy random-float 2.0 - 1 random-float 2.0 - 1
  ]
  set number-inside-circle count darts with [
    (xcor * xcor) + (ycor * ycor) < 1
  ]
  set fun-number (number-inside-circle / number-of-darts) * 4.0
  output-print "PI ~ "
  output-print fun-number
end
@#$#@#$#@
GRAPHICS-WINDOW
326
